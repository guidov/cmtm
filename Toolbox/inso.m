function [I, T, xorb, yorb, veq]=inso(t,day,lat,qinso,author,res);
%[I, T]= inso(ky,day,lat,qinso,author,res);
%
%  I      = inoslation in Watts/m^2 at top of the atmosphere.
%  T      = time vector
%  ky     = kilo-years before present; format as oldest to youngest.
...
if author==2,
  ...
  load orbitparameters.mat;		%contains time, ecc, oblE, periE, w
else,
  Orbit91;
